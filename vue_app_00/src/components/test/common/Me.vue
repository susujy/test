<template>
    <div class="page-head">
        <div class="contain">
            ...
            <div class="head">
                <div class="headImg" @click="tologin">
                    <!-- <router-link :to="login"> -->
                        <img class="Img" src="../../../assets/girl.png" alt="">
                    <!-- </router-link> -->
            ...
            <div class="like">
                <div>
                    <i class="iconfont icon-shoucangdetiezi"></i>
                    <p>收藏</p>
                </div>
                <div>
...
<style scoped>
span,p{font-family:"微软雅黑";font-weight:light}
.contain{
    position:fixed;
    z-index:999;
    width:100%;
...
.icon-fulishe-yixuanzhong{color:rgb(236, 91, 241);font-size:22px;}
</style>
